...
class NWS_Alerts_Client {
    ...
    */
    public static function scripts_styles() {
        ...
        if (defined('NWS_ALERTS_GOOGLE_MAPS_API_KEY') && NWS_ALERTS_GOOGLE_MAPS_API_KEY !== false) {
            wp_enqueue_script('google-map-api', 'https://maps.googleapis.com/maps/api/js?key=' . NWS_ALERTS_GOOGLE_MAPS_API_KEY . '&v=3.exp&libraries=weather', false, null, false);
        }
    }
