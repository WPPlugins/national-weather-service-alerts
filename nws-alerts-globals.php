...
define('NWS_ALERTS_VERSION', '1.3.4');
define('NWS_ALERTS_MIN_WP_VERSION', '3.9');
define('NWS_ALERTS_MIN_PHP_VERSION', '5.3');
...
define('NWS_ALERTS_GOOGLE_MAPS_API_KEY', get_option('nws_alerts_google_maps_api_key'));
